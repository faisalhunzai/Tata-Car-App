...
import CustomDropdownWithCheckbox from '../components/check';
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <CustomDropdownWithCheckbox
          title="Lavaggio interno"
          description="Aspirazione dell’abitacolo, pulizia cruscotto, portiere e vetri interni. Il lavaggio avrà una durata di circa 30 minuti. La durata del lavaggio può variare a seconda della condizione della vettura."
        />
        ...
        <TouchableOpacity onPress={() => navigation.navigate('CarAddScreen')}>
